              ...
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                ...
                <div className="relative">
                  <button
                    ...
                    className="bg-yellow-500 text-white rounded-md px-4 py-1 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg dark:bg-yellow-500 dark:hover:bg-yellow-600 dark:focus:ring-yellow-700"
                  >
                    {title}
                  </button>
                </div>
